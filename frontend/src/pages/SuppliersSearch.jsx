        ...
        <div className="col-12 col-lg-9 right-body-mod">
          ...
          <div className="row right-body-inner">
            <div className="col-12 col-lg-12 right-body-inner-sec1">
              <h5><span><img className="img-fluid" src="/imgs/dashboard.svg" alt="alt" width="20px" /></span>&nbsp;<span>Home</span>&nbsp;&gt;&nbsp;<span>Suppliers</span></h5>
              <h3>
                Suppliers
              </h3>
              <h5>Available Suppliers
          ...
          <div className="row right-body-inner">
            ...
            <div className="col-12 col-lg-7 right-body-inner-sec1">
              <div className="div-align-right">
                 ...
                 <a href="/suppliers" className="btn mvp-btn-launch-task d-flex align-items-center gap-2 btn-svg-btn">
                  <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18.3334 8.00016H13.3334L11.6667 10.5002H8.33342L6.66675 8.00016H1.66675M18.3334 8.00016V13.0002C18.3334 13.4422 18.1578 13.8661 17.8453 14.1787C17.5327 14.4912 17.1088 14.6668 16.6667 14.6668H3.33341C2.89139 14.6668 2.46746 14.4912 2.1549 14.1787C1.84234 13.8661 1.66675 13.4422 1.66675 13.0002V8.00016M18.3334 8.00016L15.4584 2.2585C15.3204 1.98082 15.1077 1.74714 14.8442 1.58373C14.5807 1.42032 14.2768 1.33366 13.9667 1.3335H6.03341C5.72334 1.33366 5.41947 1.42032 5.15595 1.58373C4.89244 1.74714 4.67973 1.98082 4.54175 2.2585L1.66675 8.00016" stroke="#4F4F4F" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
