...
const COLORS = ['#0d6efd', '#339af0', '#74c0fc', '#d0ebff']; // Blue color variations
                ...
                <div className="py-6 px-6 mvp-left-panel-outer mvp-left-panel-middle">
                  <div className="mvp-left-panel-inner">
                    <ul className="nav flex-column mb-8 mvp-lpi-top">
                      ...
                      <li className="nav-item nav-pills">
                        <a className="nav-link mvp-dashboard-item-selected text-white  p-3 d-flex align-items-center" href="/budget">
                          <span className="d-inline-flex  ms-3 me-3">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M15.0333 11.4207C14.6833 11.7624 14.4833 12.2541 14.5333 12.7791C14.6083 13.6791 15.4333 14.3374 16.3333 14.3374H17.9167V15.3291C17.9167 17.0541 16.5083 18.4624 14.7833 18.4624H5.21667C3.49167 18.4624 2.08334 17.0541 2.08334 15.3291V9.72074C2.08334 7.99574 3.49167 6.5874 5.21667 6.5874H14.7833C16.5083 6.5874 17.9167 7.99574 17.9167 9.72074V10.9207H16.2333C15.7667 10.9207 15.3417 11.1041 15.0333 11.4207Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M2.08334 10.4707V6.66245C2.08334 5.67078 2.69167 4.78741 3.61667 4.43741L10.2333 1.93741C11.2667 1.54575 12.375 2.31244 12.375 3.42077V6.58743" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M18.799 11.7709V13.4876C18.799 13.9459 18.4323 14.3209 17.9657 14.3375H16.3323C15.4323 14.3375 14.6073 13.6792 14.5323 12.7792C14.4823 12.2542 14.6823 11.7625 15.0323 11.4209C15.3407 11.1042 15.7657 10.9209 16.2323 10.9209H17.9657C18.4323 10.9376 18.799 11.3125 18.799 11.7709Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M5.83334 10.1292H11.6667" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>

                          </span>
                          <span className="small text-white me-auto">Budget</span>
                          <span className="d-inline-block "></span>
                        </a>
                      </li>
                      <li className="nav-item nav-pills">
        ...
        <div className="col-12 col-lg-9 right-body-mod">
          ...
          <div className="row right-body-inner ">
            <div className="col-12 col-lg-12 right-body-inner-sec1">
              <h5><span><img className="img-fluid" src="/imgs/dashboard.svg" alt="alt" width="20px" /></span>&nbsp;&nbsp;<a className="mvp-no-text-deco" href=""><span className="mvp-breadcrump-root">Home</span></a>&nbsp;&gt;&nbsp;<span className="mvp-breadcrump-in">Budget</span></h5>
          ...
          <div className="row right-body-inner  remove-padding-topbottom">
            ...
            <div className="col-12 col-lg-4 ">
              <div className="container" >
                ...
                <div className="input-group">
                  ...
                  <select
                    className="form-select mvp-select-mod"
                  >
            ...
            <div className="col-12 col-lg-8">
              <div className="container div-align-right">
                <a href="#" className="btn mvp-btn-refinance d-flex align-items-center gap-2 btn-svg-btn">
                  <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.8129 3.51862C10.8139 2.49546 8.72756 1.66675 6.15693 1.66675C3.5863 1.66675 1.50186 2.49639 1.5 3.51862M1.5 3.51862C1.5 4.54178 3.58444 5.37049 6.15693 5.37049C8.72942 5.37049 10.8139 4.54178 10.8139 3.51862L10.8139 10.7038M1.5 3.51862V14.6298C1.50093 15.6529 3.58537 16.4817 6.15693 16.4817C7.40406 16.4817 8.5301 16.2844 9.36556 15.9668M1.50093 7.22235C1.50093 8.24551 3.58538 9.07422 6.15787 9.07422C8.73036 9.07422 10.8148 8.24551 10.8148 7.22235M9.42144 12.2456C8.58133 12.5743 7.42921 12.778 6.15693 12.778C3.58537 12.778 1.50093 11.9493 1.50093 10.9261M16.106 11.2206C17.7424 12.8475 17.7424 15.4864 16.106 17.1133C14.4696 18.7401 11.8151 18.7401 10.1787 17.1133C8.54221 15.4864 8.54221 12.8475 10.1787 11.2206C11.8151 9.59374 14.4696 9.59374 16.106 11.2206Z" stroke="white" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
          ...
          <div className=" right-body-inner">
            ...
            <div className="section-inner-budget">
              <div className="col-12 col-lg-4 mvp-sml-tile">
                <div className="mvp-sml-tile-inner">
                  <p>Suggested Monthly Savings</p>
                ...
                <div className="mvp-sml-tile-inner-tile">
                  <div >
                    <h6>2,420 $</h6>
                    <div>
                      <span className="badge bg-light text-dark d-inline-flex align-items-center gap-2 p-2 fs-6">
                  ...
                  <div className="div-align-right tile-sec-right">
                    <a href="#">
                      <img
                        className="img-fluid"
                        src="/imgs/chart_up.png"
                        alt="alt"
                        width="100px"
                      />
                    </a>
                ...
                <div className="mvp-sml-tile-inner-tile">
                  <div >
                    ...
                    <div>
                      ...
                      <label>increase in valuation</label>
            ...
            <div className="row ">
              <div className="col-12 col-lg-5">
                ...
                <div className="container mt-4">
                  <h5 className="mb-4">Donut Chart: Blue Variants with Right Legend</h5>
                  <div className="bg-light p-4 rounded shadow-sm">
                    <ResponsiveContainer width="100%" height={350}>
                      <PieChart layout="horizontal">
                        <Pie
                          data={dataPie}
                          cx="40%"         // move donut left to make space for legend
                          cy="50%"
                          innerRadius={60} // increased for thicker donut
                          outerRadius={110}
                          fill="#8884d8"
                          paddingAngle={2}
                          dataKey="value"
              ...
              <div className="col-12 col-lg-7">
                ...
                <div className="container mt-4">
                  <h5 className="mb-4">Expenditures per year</h5>
                  <div className="bg-light p-4 rounded shadow-sm">
                    <ResponsiveContainer width="100%" height={400}>
                      <BarChart data={data} margin={{ top: 20, right: 30, left: 40, bottom: 50 }}>
                        ...
                        <Bar dataKey="value" fill="#0d6efd" name="Projected Valuation" />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </div>
