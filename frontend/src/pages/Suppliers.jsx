...
const generateData = () =>
  Array.from({ length: 30 }, (_, i) => ({
    ...
    date: new Date(2025, 3, (i % 28) + 1).toISOString().split('T')[0],
    orderId: `ORD-${1000 + i}`,
...
const Suppliers = () => {
  ...
  const toggleSelectAll = (e) => {
    ...
    setSelected(e.target.checked ? pageData.map((row) => row.id) : []);
  };
                ...
                <div className="py-6 px-6 mvp-left-panel-outer mvp-left-panel-middle">
                  <div className="mvp-left-panel-inner">
                    <ul className="nav flex-column mb-8 mvp-lpi-top">
                      ...
                      <li className="nav-item nav-pills">
                        <a className="nav-link mvp-dashboard-item-selected text-white  p-3 d-flex align-items-center" href="/suppliers">
                          <span className="d-inline-flex  ms-3 me-3">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1.66666 18.4629H18.3333" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M2.45833 18.4628L2.5 8.43776C2.5 7.92943 2.74166 7.44614 3.14166 7.12947L8.97499 2.58779C9.57499 2.12113 10.4167 2.12113 11.025 2.58779L16.8583 7.12113C17.2667 7.4378 17.5 7.92109 17.5 8.43776V18.4628" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linejoin="round" />
                              <path d="M12.9167 9.2959H7.08334C6.39167 9.2959 5.83334 9.85423 5.83334 10.5459V18.4626H14.1667V10.5459C14.1667 9.85423 13.6083 9.2959 12.9167 9.2959Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M8.33334 13.6709V14.9209" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M8.75 6.37939H11.25" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>


                          </span>
                          <span className="small  me-auto text-white">Suppliers</span>
        ...
        <div className="col-12 col-lg-9 right-body-mod">
          ...
          <div className="row right-body-inner">
            <div className="col-12 col-lg-12 right-body-inner-sec1">
              <h5><span><img className="img-fluid" src="/imgs/dashboard.svg" alt="alt" width="20px" /></span>&nbsp;&nbsp;<a className="mvp-no-text-deco" href=""><span className="mvp-breadcrump-root">Home</span></a>&nbsp;&gt;&nbsp;<span className="mvp-breadcrump-in">Suppliers</span></h5>
              <h3 className="mvp-category-select-text ">
                Suppliers
              </h3>
              <h5 className="mvp-category-select-sub-text ">Submitted Work Orders
              ...
              <div className="col-12 col-lg-12">
                ...
                <div className="container mt-4">
                  <h5 className="mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <select
                      className="form-select w-auto  mvp-select-mod"
                      value={statusFilter}
                      onChange={(e) => {
                    ...
                    <div className="col-12 col-lg-7 right-body-inner-sec1">
                      <div className="div-align-right">

                        <a href="/suppliers-search" className="btn mvp-btn-launch-task d-flex align-items-center gap-2 btn-svg-btn">
                          <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13.3334 12.3333V1.5H0.833374V12.3333H13.3334ZM13.3334 12.3333H19.1667V8.16667L16.6667 5.66667H13.3334V12.3333ZM6.66671 14.4167C6.66671 15.5673 5.73397 16.5 4.58337 16.5C3.43278 16.5 2.50004 15.5673 2.50004 14.4167C2.50004 13.2661 3.43278 12.3333 4.58337 12.3333C5.73397 12.3333 6.66671 13.2661 6.66671 14.4167ZM17.5 14.4167C17.5 15.5673 16.5673 16.5 15.4167 16.5C14.2661 16.5 13.3334 15.5673 13.3334 14.4167C13.3334 13.2661 14.2661 12.3333 15.4167 12.3333C16.5673 12.3333 17.5 13.2661 17.5 14.4167Z" stroke="#4F4F4F" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
                          </svg>
                    ...
                    <thead className="table-light">
                      <tr>
                        <th>
                          <input
                            type="checkbox"
                            checked={currentRows.every((row) => selected.includes(row.id))}
                    ...
                    <tbody>
                      {currentRows.map((row) => (
                        <tr key={row.id}>
                          ...
                          <td>
                            <div>{row.title}</div>
                            <div className="text-muted small">{row.subtitle}</div>
                          </td>
                          <td>{row.date}</td>
                          <td>{row.orderId}</td>
                          ...
                          <td>
                            <div className="d-flex align-items-center gap-2">
                              ...
                              <div>
                                ...
                                <div className="text-muted small">{row.userRole}</div>
                              </div>
                            </div>
                          </td>
                          <td>
