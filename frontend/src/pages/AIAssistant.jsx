  ...
  return (
    <div className="container-fluid">
      <div className="row mvp-main-container">
        <div className="col-12 col-lg-3 left-nav-mod ai-left-mod">
                ...
                <div className="py-6 px-6 mvp-left-panel-outer mvp-left-panel-middle">
                  <div className="mvp-left-panel-inner">
                    <ul className="nav flex-column mb-8 mvp-lpi-top">
                      ...
                      <li className="nav-item nav-pills">
                        <a className="nav-link p-3 d-flex mvp-dashboard-item-selected text-white  align-items-center" href="/ai-assistant">
                          <span className="d-inline-flex ms-3 me-3">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M2.91667 17.2124C3.60834 17.9041 4.725 17.9041 5.41667 17.2124L16.25 6.3791C16.9417 5.68743 16.9417 4.57077 16.25 3.8791C15.5583 3.18743 14.4417 3.18743 13.75 3.8791L2.91667 14.7124C2.225 15.4041 2.225 16.5208 2.91667 17.2124Z" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M15.0083 7.62109L12.5083 5.12109" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M7.08334 2.16257L8.33334 1.7959L7.96667 3.0459L8.33334 4.2959L7.08334 3.92923L5.83334 4.2959L6.2 3.0459L5.83334 1.7959L7.08334 2.16257Z" fill="white" />
                              <path d="M3.75 7.16256L5 6.7959L4.63333 8.0459L5 9.2959L3.75 8.92923L2.5 9.2959L2.86667 8.0459L2.5 6.7959L3.75 7.16256Z" fill="white" />
                              <path d="M16.25 11.3296L17.5 10.9629L17.1333 12.2129L17.5 13.4629L16.25 13.0962L15 13.4629L15.3667 12.2129L15 10.9629L16.25 11.3296Z" fill="white" />
                            </svg>
                          </span>
                          <span className="small me-auto text-white">Assistant</span>
        ...
        <div className="col-12 col-lg-9 ai-section-main d-flex flex-column justify-content-center align-items-center">
          <div className="ai-second-first d-flex flex-column justify-content-center align-items-center">
            <div className="d-flex justify-content-center align-items-center text-center gap-3">
              <img
                src="imgs/ai-home.png"
                alt="User"
              />
              <h2 className="mb-0">Assistant</h2>
            </div>

            <div>
              <p>
                Your smart assistant for effortlessly managing home maintenance, expenses and energy efficiency.
              </p>
            </div>
          </div >


          <div className="row ai-second-sec align-items-start">
            <div className="col-12 col-lg-6 d-flex flex-column justify-content-center ">
              ...
              <div className="ai-quiz-box d-flex flex-column">
                <p>
                  Remind me to clean the furnace filters every three months.
                </p>
              </div>
              <div className="ai-quiz-box d-flex flex-column">
                <p>
              ...
              <div className="ai-quiz-box d-flex flex-column">
                <p>
                  How to clean my dishwasher filters?
                </p>
              </div>
              <div className="ai-quiz-box d-flex flex-column">
                <p>
                  What kind of maintenance tasks I can do myself?
                </p>
              </div>
            ...
            <div className="col-12 col-lg-6 d-flex flex-column justify-content-center ">
              ...
              <div className="ai-quiz-box d-flex flex-column">
                <p>
                  Set personalized reminders for routine home maintenance tasks.
                </p>
              </div>

              <div className="ai-quiz-box d-flex flex-column">
                <p>
                  Track household expenses and provide real-time budget updates.
                </p>
              </div>

              <div className="ai-quiz-box d-flex flex-column">
                <p>
                  Recommend top-rated local professionals for home services.
                </p>
              </div>
          ...
          <div className="row ai-second-sec align-items-start search-box-container">




            <div className="d-flex align-items-center px-3 py-2 bg-light ai-search-box" >
              <button className="btn p-0 me-3 bg-transparent border-0">
                <FaPaperclip />
              </button>
              ...
              <button className="btn p-0 ms-3 bg-transparent border-0">
                <FaPaperPlane />
              </button>
            </div>
