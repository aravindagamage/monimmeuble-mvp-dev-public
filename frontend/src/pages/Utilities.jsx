...
const generateData = () =>
  Array.from({ length: 24 }, (_, i) => ({
    ...
    userName: `User ${i + 1}`,
    userRole: `Role ${i + 1}`,
    services: ['Design', 'Development', 'Consulting'].filter((_, j) => (i + j) % 2 === 0),
    detailsTitle: `Project ${i + 1}`,
    detailsSub: `Started: ${new Date(2025, 0, (i % 28) + 1).toLocaleDateString()}`,
                ...
                <div className="py-6 px-6 mvp-left-panel-outer mvp-left-panel-middle">
                  <div className="mvp-left-panel-inner">
                    <ul className="nav flex-column mb-8 mvp-lpi-top">
                      ...
                      <li className="nav-item nav-pills">
                        <a className="nav-link mvp-dashboard-item-selected text-white  p-3 d-flex align-items-center" href="/Utilities">
                          <span className="d-inline-flex ms-3 me-3">
                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M10.5 16.1294H13.5C16 16.1294 17.5 14.3294 17.5 12.1294V7.0394C17.5 5.9894 16.64 5.12939 15.59 5.12939H8.42C7.37 5.12939 6.51 5.9894 6.51 7.0394V12.1294C6.5 14.3294 7.99999 16.1294 10.5 16.1294Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M9.5 2.12939V5.12939" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M14.5 2.12939V5.12939" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M12 22.1294V16.1294" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>

                          </span>
                          <span className="small me-auto text-white ">Utilities</span>
                          <span className="d-inline-block "></span>
                        </a>
                      </li>
                      <li className="nav-item nav-pills">
        ...
        <div className="col-12 col-lg-9 right-body-mod">
          ...
          <div className="row right-body-inner">
            <div className="col-12 col-lg-12 right-body-inner-sec1">
              ...
              <h5><span><img className="img-fluid" src="/imgs/dashboard.svg" alt="alt" width="20px" /></span>&nbsp;&nbsp;<a className="mvp-no-text-deco" href=""><span className="mvp-breadcrump-root">Home</span></a>&nbsp;&gt;&nbsp;<span className="mvp-breadcrump-in">Utilities</span></h5>
              <h3 className="mvp-category-select-text ">
                Utilities
              </h3>
              <h5 className="mvp-category-select-sub-text ">
                Available Utilities
              </h5>
            </div>
          </div>
              ...
              <div className="col-12 col-lg-12">
                ...
                <div className="container mt-4">
                  <h5 className="mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="/documents" className="btn mvp-btn-launch-task d-flex align-items-center gap-2 btn-svg-btn">
                      <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.3333 8.00016H13.3333L11.6666 10.5002H8.33329L6.66663 8.00016H1.66663M18.3333 8.00016V13.0002C18.3333 13.4422 18.1577 13.8661 17.8451 14.1787C17.5326 14.4912 17.1087 14.6668 16.6666 14.6668H3.33329C2.89127 14.6668 2.46734 14.4912 2.15478 14.1787C1.84222 13.8661 1.66663 13.4422 1.66663 13.0002V8.00016M18.3333 8.00016L15.4583 2.2585C15.3203 1.98082 15.1076 1.74714 14.8441 1.58373C14.5806 1.42032 14.2767 1.33366 13.9666 1.3335H6.03329C5.72322 1.33366 5.41935 1.42032 5.15583 1.58373C4.89231 1.74714 4.67961 1.98082 4.54163 2.2585L1.66663 8.00016" stroke="#4F4F4F" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    ...
                    <tbody>
                      {currentRows.map((row) => (
                        <tr key={row.id}>
                          ...
                          <td>
                            <div>{row.detailsTitle}</div>
                            <div className="text-muted small">{row.detailsSub}</div>
                          </td>
                          <td>
