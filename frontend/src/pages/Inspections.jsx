                ...
                <div className="py-6 px-6 mvp-left-panel-outer mvp-left-panel-middle">
                  <div className="mvp-left-panel-inner">
                    <ul className="nav flex-column mb-8 mvp-lpi-top">
                      ...
                      <li className="nav-item nav-pills">
                        <a className="nav-link mvp-dashboard-item-selected text-white  p-3 d-flex align-items-center" href="/inspections">
                          <span className="d-inline-flex  ms-3 me-3">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M8.33334 14.7124H11.6667" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M1.66666 14.7124V6.37907C1.66666 3.04574 2.5 2.2124 5.83333 2.2124" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M18.3333 14.7124V6.37907C18.3333 3.04574 17.5 2.2124 14.1667 2.2124" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M8.33333 13.3875V16.1292C8.33333 17.7959 7.66666 18.4625 6 18.4625H4C2.33333 18.4625 1.66666 17.7959 1.66666 16.1292V13.3875C1.66666 11.7209 2.33333 11.0542 4 11.0542H6C7.66666 11.0542 8.33333 11.7209 8.33333 13.3875Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M18.3333 13.3875V16.1292C18.3333 17.7959 17.6667 18.4625 16 18.4625H14C12.3333 18.4625 11.6667 17.7959 11.6667 16.1292V13.3875C11.6667 11.7209 12.3333 11.0542 14 11.0542H16C17.6667 11.0542 18.3333 11.7209 18.3333 13.3875Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>

                          </span>
                          <span className="small  me-auto text-white ">Inspections</span>
                          <span className="d-inline-block "></span>
                        </a>
                      </li>
                      <li className="nav-item nav-pills">
        ...
        <div className="col-12 col-lg-9 right-body-mod">
          ...
          <div className="row right-body-inner ">
            <div className="col-12 col-lg-12 right-body-inner-sec1">
              <h5><span><img className="img-fluid" src="/imgs/dashboard.svg" alt="alt" width="20px" /></span>&nbsp;&nbsp;<a className="mvp-no-text-deco" href=""><span className="mvp-breadcrump-root">Home</span></a>&nbsp;&gt;&nbsp;<span className="mvp-breadcrump-in">Inspection</span></h5>
          ...
          <div className="row right-body-inner remove-padding-topbottom">
            <div className="col-12 col-lg-5 right-body-inner-sec1">
              <form action="#" method="post">
                <div className="mb-6">
                  <div className="input-group mvp-input-group">
                    <span className="input-group-text mvp-input-support-mod">
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M16.5 16.5L12.875 12.875M14.8333 8.16667C14.8333 11.8486 11.8486 14.8333 8.16667 14.8333C4.48477 14.8333 1.5 11.8486 1.5 8.16667C1.5 4.48477 4.48477 1.5 8.16667 1.5C11.8486 1.5 14.8333 4.48477 14.8333 8.16667Z" stroke="#3D3D3D" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </span>
                    <input
                      type="text"
                      className="form-control mvp-input-mod"
                      id="username"
                      placeholder="Search"
            ...
            <div className="col-12 col-lg-7 mvp-planner-right-body-inner-sec1">
              <a href="/inspections-view" className="btn mvp-btn-launch-task d-flex align-items-center gap-2 btn-svg-btn">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8 15V1M8 1L1 8M8 1L15 8" stroke="#4F4F4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>


                Upload Report
              </a>
              <button className="btn mvp-btn-launch-task d-flex align-items-center gap-2 btn-svg-btn">
                <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M11.3334 3.33341H13C13.4421 3.33341 13.866 3.50901 14.1786 3.82157C14.4911 4.13413 14.6667 4.55805 14.6667 5.00008V16.6667C14.6667 17.1088 14.4911 17.5327 14.1786 17.8453C13.866 18.1578 13.4421 18.3334 13 18.3334H3.00004C2.55801 18.3334 2.13409 18.1578 1.82153 17.8453C1.50897 17.5327 1.33337 17.1088 1.33337 16.6667V5.00008C1.33337 4.55805 1.50897 4.13413 1.82153 3.82157C2.13409 3.50901 2.55801 3.33341 3.00004 3.33341H4.66671M5.50004 1.66675H10.5C10.9603 1.66675 11.3334 2.03984 11.3334 2.50008V4.16675C11.3334 4.62699 10.9603 5.00008 10.5 5.00008H5.50004C5.0398 5.00008 4.66671 4.62699 4.66671 4.16675V2.50008C4.66671 2.03984 5.0398 1.66675 5.50004 1.66675Z" stroke="#4F4F4F" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            ...
            <div className="row section-bottom-valuation">
              <div className="col-12 col-lg-12">
                ...
                <div className="container mt-4">
                  ...
                  <table className="table table-bordered table-hover clean-verticals clean-verticals-inspection">
                    <thead className="">
                      <tr>
                        <th className=" valuation-table-th" ><input type="checkbox" /></th>
                        <th className="div-align-left-t valuation-table-th" >Inspection Report</th>
                        <th className=" valuation-table-th" >Inspection date</th>
                        <th className=" valuation-table-th" ></th>
                        <th className="div-align-left-t  valuation-table-th" >Inspected by</th>
                        <th className=" valuation-table-th" >Actions</th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><div class="d-flex align-items-center gap-2">
                          ...
                          <div className="div-align-left-t">
                            <div class="fw-bold">Home Inspection Report</div>
                            <div class="text-muted small">Your Property 1 </div>
                          </div>
                        </div>
                        </td>
                        <td className="tbl-def-text">Mar 12, 2024</td>
                        <td><a href="" className="tbl-def-text-link">View</a></td>
                        <td><div class="d-flex align-items-center gap-2">
                          <img alt="User 1" class="rounded-circle" width="40" height="40" src="/imgs/Avatar.png" />
                          <div className="div-align-left-t">
                            <div class="fw-bold">Home Inspection Report</div>
                            <div class="text-muted small">Ontario</div>
                          </div>
                        </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td><div class="d-flex align-items-center gap-2">
                          ...
                          <div className="div-align-left-t">
                            <div class="fw-bold">Home Inspection Report</div>
                            <div class="text-muted small">Your Property 2</div>
                          </div>
                        </div>
                        </td>
                        <td className="tbl-def-text">Feb 04, 2023</td>
                        <td><a href="" className="tbl-def-text-link">View</a></td>
                        <td><div class="d-flex align-items-center gap-2">
                          <img alt="User 1" class="rounded-circle" width="40" height="40" src="/imgs/Avatar.png" />
                          <div className="div-align-left-t">
                            <div class="fw-bold">Home Inspection Report</div>
                            <div class="text-muted small">Saskatchewan</div>
                          </div>
                        </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td className="tbl-def-text">Jan 13, 2022</td>
                        <td><a href="" className="tbl-def-text-link">View</a></td>
                        <td><div class="d-flex align-items-center gap-2">
                          <img alt="User 1" class="rounded-circle" width="40" height="40" src="/imgs/Avatar.png" />
                          <div className="div-align-left-t">
                            <div class="fw-bold">Home Inspection Report</div>
                            <div class="text-muted small">Manitoba</div>
                          </div>
                        </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td className="tbl-def-text">Jan 23, 2021</td>
                        <td><a href="" className="tbl-def-text-link">View</a></td>
                        <td><div class="d-flex align-items-center gap-2">
                          <img alt="User 1" class="rounded-circle" width="40" height="40" src="/imgs/Avatar.png" />
                          <div className="div-align-left-t">
                            <div class="fw-bold">3129 Hayman Rd</div>
                            <div class="text-muted small">British Columbia</div>
                          </div>
                        </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td className="tbl-def-text">Jan 12, 2022</td>
                        <td><a href="" className="tbl-def-text-link">View</a></td>
                        <td><div class="d-flex align-items-center gap-2">
                          <img alt="User 1" class="rounded-circle" width="40" height="40" src="/imgs/Avatar.png" />
                          <div className="div-align-left-t">
