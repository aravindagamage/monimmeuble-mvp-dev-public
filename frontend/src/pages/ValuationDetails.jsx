        ...
        <div className="col-12 col-lg-9 right-body-mod">
          ...
          <div className="row right-body-inner">
            <div className="col-12 col-lg-12 right-body-inner-sec1">
              <h5><span><img className="img-fluid" src="/imgs/dashboard.svg" alt="alt" width="20px" /></span>&nbsp;&nbsp;<a className="mvp-no-text-deco" href=""><span className="mvp-breadcrump-root">Home</span></a>&nbsp;&gt;&nbsp;<a className="mvp-no-text-deco" href="/valuation"><span className="mvp-breadcrump-root">Valuation</span></a>&nbsp;&gt;&nbsp;<span className="mvp-breadcrump-in">Value Gain</span></h5>
...
<path d="M6.5 18.3334V10.0001H11.5V18.3334M1.5 7.50008L9 1.66675L16.5 7.50008V16.6667C16.5 17.1088 16.3244 17.5327 16.0118 17.8453C15.6993 18.1578 15.2754 18.3334 14.8333 18.3334H3.16667C2.72464 18.3334 2.30072 18.1578 1.98816 17.8453C1.67559 17.5327 1.5 17.1088 1.5 16.6667V7.50008Z" stroke="#667085" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div className="col-12 col-lg-8">
              <div className="container div-align-right">
                <a href="/valuation" className="btn mvp-btn-launch-task d-flex align-items-center gap-2 btn-svg-btn">
                  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 16L11 21L21 16M1 11L11 16L21 11M11 1L1 6L11 11L21 6L11 1Z" stroke="#4F4F4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
            ...
            <div className="row ">
              <div className="col-12 col-lg-7">
                ...
                <div className="container mt-4">
                  <h5 className="mb-4">Projected Valuation Growth (2024 - 2031)</h5>
              ...
              <div className="col-12 col-lg-5">
                <div className="sec-valuation-value-area">
                <h2>2.2 %</h2>
                <div className="sec-top">
                  ...
                  <label className="val-notice">Average annual earnings</label>
                ...
                <div  className="sec-bottom">
                  ...
                  <label className="val-notice">Quebec average</label>
