...
const generateData = () =>
  Array.from({ length: 24 }, (_, i) => ({
    ...
    text1: `Info ${i + 1}`,
    text2: `Note ${i + 1}`,
    dateInfo: `Joined: ${new Date(2025, 0, (i % 28) + 1).toLocaleDateString()}`,
    badgeNote: `Verified ${i + 1}`,
                ...
                <div className="py-6 px-6 mvp-left-panel-outer mvp-left-panel-middle">
                  <div className="mvp-left-panel-inner">
                    <ul className="nav flex-column mb-8 mvp-lpi-top">
                      ...
                      <li className="nav-item nav-pills">
                        <a className="nav-link mvp-dashboard-item-selected text-white  p-3 d-flex align-items-center" href="/financing">
                          <span className="d-inline-flex  ms-3 me-3">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M7.22656 12.0711C7.22656 13.1461 8.05156 14.0128 9.07656 14.0128H11.1682C12.0599 14.0128 12.7849 13.2544 12.7849 12.3211C12.7849 11.3044 12.3432 10.9461 11.6849 10.7128L8.32656 9.54609C7.66823 9.31276 7.22656 8.95443 7.22656 7.93776C7.22656 7.00443 7.95156 6.24609 8.84323 6.24609H10.9349C11.9599 6.24609 12.7849 7.11276 12.7849 8.18776" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M10 5.12939V15.1294" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M12.5 18.4626H7.5C3.33333 18.4626 1.66666 16.7959 1.66666 12.6292V7.62923C1.66666 3.46257 3.33333 1.7959 7.5 1.7959H12.5C16.6667 1.7959 18.3333 3.46257 18.3333 7.62923V12.6292C18.3333 16.7959 16.6667 18.4626 12.5 18.4626Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>



                          </span>
                          <span className="small me-auto  text-white ">Financing</span>
                          <span className="d-inline-block "></span>
                        </a>
                      </li>
                      <li className="nav-item nav-pills">
        ...
        <div className="col-12 col-lg-9 right-body-mod">
          ...
          <div className="row right-body-inner">
            <div className="col-12 col-lg-12 right-body-inner-sec1">
              ...
              <h5><span><img className="img-fluid" src="/imgs/dashboard.svg" alt="alt" width="20px" /></span>&nbsp;&nbsp;<a className="mvp-no-text-deco" href=""><span className="mvp-breadcrump-root">Home</span></a>&nbsp;&gt;&nbsp;<span className="mvp-breadcrump-in">Financing</span></h5>
                    ...
                    <tbody>
                      {currentRows.map((row) => (
                        <tr key={row.id}>
                          ...
                          <td>{row.text2}</td>
                          <td>
                            <div>{row.dateInfo}</div>
                            <div className="text-muted small">{row.badgeNote}</div>
                          </td>
                          <td>
                            <span className="badge bg-info text-dark d-flex align-items-center gap-1">
                              <BsShieldLockFill size={14} /> {row.securityLevel}
                            </span>
                          </td>
                          <td>
