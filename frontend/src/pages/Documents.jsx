                ...
                <div className="py-6 px-6 mvp-left-panel-outer mvp-left-panel-middle">
                  <div className="mvp-left-panel-inner">
                    <ul className="nav flex-column mb-8 mvp-lpi-top">
                      ...
                      <li className="nav-item nav-pills">
                        <a className="nav-link mvp-dashboard-item-selected text-white p-3 d-flex align-items-center" href="/documents">
                          <span className="d-inline-flex ms-3 me-3">
                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M9 22.1294H15C20 22.1294 22 20.1294 22 15.1294V9.12939C22 4.12939 20 2.12939 15 2.12939H9C4 2.12939 2 4.12939 2 9.12939V15.1294C2 20.1294 4 22.1294 9 22.1294Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M15.75 9.12939H8.25" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M15.75 15.1294H8.25" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>

                          </span>
                          <span className="small me-auto text-white ">Documents</span>
                          <span className="d-inline-block "></span>
                        </a>
                      </li>
        ...
        <div className="col-12 col-lg-9 right-body-mod">
          ...
          <div className="row right-body-inner ">
            <div className="col-12 col-lg-12 right-body-inner-sec1">
              <h5><span><img className="img-fluid" src="/imgs/dashboard.svg" alt="alt" width="20px" /></span>&nbsp;&nbsp;<a className="mvp-no-text-deco" href=""><span className="mvp-breadcrump-root">Home</span></a>&nbsp;&gt;&nbsp;<span className="mvp-breadcrump-in">Documents</span></h5>
          ...
          <div className="row right-body-inner remove-padding-topbottom">
            ...
            <div className="col-12 col-lg-7 mvp-planner-right-body-inner-sec1">
              <a href="#" className="btn mvp-btn-launch-task d-flex align-items-center gap-2 btn-svg-btn">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7.49992 14.1665V9.1665L5.83325 10.8332" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M7.5 9.1665L9.16667 10.8332" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M18.3334 8.33317V12.4998C18.3334 16.6665 16.6667 18.3332 12.5001 18.3332H7.50008C3.33341 18.3332 1.66675 16.6665 1.66675 12.4998V7.49984C1.66675 3.33317 3.33341 1.6665 7.50008 1.6665H11.6667" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M18.3334 8.33317H15.0001C12.5001 8.33317 11.6667 7.49984 11.6667 4.99984V1.6665L18.3334 8.33317Z" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
