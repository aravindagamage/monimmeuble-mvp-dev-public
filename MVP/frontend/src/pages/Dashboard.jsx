    ...
    <div className="container-fluid">
      <div className="row mvp-main-container">
                  ...
                  <div className="mvp-left-panel-inner">
                    <ul className="nav flex-column mb-8 mvp-lpi-top">
                      <li className="nav-item nav-pills">
                        <a className="nav-link mvp-dashboard-item-selected text-white p-3 d-flex align-items-center mvp-nav-item" href="/">
                          <span className="d-inline-flex ms-3 me-3">

                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M10 15.1293V12.6293" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M8.39166 2.47925L2.61666 7.10425C1.96666 7.62092 1.55 8.71258 1.69166 9.52925L2.8 16.1626C3 17.3459 4.13333 18.3042 5.33333 18.3042H14.6667C15.8583 18.3042 17 17.3376 17.2 16.1626L18.3083 9.52925C18.4417 8.71258 18.025 7.62092 17.3833 7.10425L11.6083 2.48758C10.7167 1.77092 9.275 1.77092 8.39166 2.47925Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                          </span>
                          <span className="small me-auto text-white ">Dashboard</span>
        ...
        <div className="col-12 col-lg-9 right-body-mod">
          <div className="row dash-right-body-inner-top">
            <div className="col-12 col-lg-8 right-body-inner-sec1">
              <h2>Welcome back, Jennifer</h2>
              <p>
                Track, manage and forecast your home maintenance.
              </p>
            </div>
            <div className="col-12 col-lg-4 mvp-container-align-right">
              <div className="mvp-up-pay-container">
                <div className="d-flex ">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.33325 8.40662H12.6666" stroke="#36A8FA" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M12.6666 6.8533V11.62C12.6466 13.52 12.1266 14 10.1466 14H3.85327C1.83994 14 1.33325 13.5 1.33325 11.5133V6.8533C1.33325 5.0533 1.75325 4.47331 3.33325 4.37997C3.49325 4.37331 3.6666 4.36664 3.85327 4.36664H10.1466C12.1599 4.36664 12.6666 4.86664 12.6666 6.8533Z" stroke="#36A8FA" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M14.6666 4.48667V9.14667C14.6666 10.9467 14.2466 11.5267 12.6666 11.62V6.85333C12.6666 4.86667 12.1599 4.36667 10.1466 4.36667H3.85327C3.6666 4.36667 3.49325 4.37333 3.33325 4.38C3.35325 2.48 3.87327 2 5.85327 2H12.1466C14.1599 2 14.6666 2.5 14.6666 4.48667Z" stroke="#36A8FA" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M3.5 11.8734H4.64665" stroke="#36A8FA" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M6.07336 11.8734H8.3667" stroke="#36A8FA" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                  <h5 className="pay-notification">&nbsp;Upcoming Payment</h5>
                </div>

                <p className="pay-description div-align-left-t">
                  There is an upcoming maintenance payment for the Air Conditioning service. <a href="#">View</a>
                </p>
              </div>
          ...
          <div className=" right-body-inner">
            <div className="row right-body-inner-sec2">
              <div className="col-12 col-lg-6 right-body-inner-sec2-left-cont">
                <div className="right-body-inner-sec2-left">
                  <h3 className="mvp-title-sub div-align-left-t">Lets start by creating</h3>
                  <h3 className="mvp-title-sub div-align-left-t">your first task</h3>
              ...
              <div className="col-12 col-lg-6 mvp-dash-grid">
                <div className="right-body-inner sec2-wrapper">
                  <div className="icon-rounded-wrapper">
                    <a href="/newtask-planner">
                      <img
                        className="img-fluid"
          ...
          <div className=" right-body-inner">
            <div className="row right-body-inner-sec3">
              <div className="col-12 col-lg-8">
                <div className="right-body-inner-sec3-left">
                  <h3 className="mvp-title-sub div-align-left-t">Use wizard to find</h3>
                  <h3 className="mvp-title-sub div-align-left-t">your task</h3>
                  <a href="/planner" className="btn mvp-btn-launch-task d-flex align-items-center gap-2">
                    <FaPlus />
                    Launch Task Wizard
                  </a>
              ...
              <div className="col-12 col-lg-4">
                <div className="right-body-inner-sec3-right">
                  <img
                    className="img-fluid"
                    src="/imgs/dash-wand.png"
                    alt="alt"
                    width="200px"
                  />
                </div>
