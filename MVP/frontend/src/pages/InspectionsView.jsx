        ...
        <div className="col-12 col-lg-9 right-body-mod">
          ...
          <div className="row right-body-inner">
            <div className="col-12 col-lg-12 right-body-inner-sec1">
              <h5><span><img className="img-fluid" src="/imgs/dashboard.svg" alt="alt" width="20px" /></span>&nbsp;<span>Home</span>&nbsp;&gt;&nbsp;<span>Inspection</span></h5>
              <h3>
            ...
            <div className="row ">
              <div className="col-12 col-lg-12">
                ...
                <div className="container mt-4">
                  <div className="d-flex justify-content-between align-items-center bg-light p-2 border rounded-top">
                    <strong>PDF Viewer</strong>
                    <a href={pdfUrl} download className="btn btn-outline-primary btn-sm">
                ...
                <div className="border border-top-0 p-3 rounded-bottom bg-white" >
