        ...
        <div className="col-12 col-lg-9 right-body-mod">
          ...
          <div className="row right-body-inner ">
            <div className="col-12 col-lg-12 right-body-inner-sec1">
              <h5><span><img className="img-fluid" src="/imgs/dashboard.svg" alt="alt" width="20px" /></span>&nbsp;&nbsp;<a className="mvp-no-text-deco" href=""><span className="mvp-breadcrump-root">Home</span></a>&nbsp;&gt;&nbsp;<span className="mvp-breadcrump-in">Planner</span></h5>
          ...
          <div className="row right-body-inner remove-padding-topbottom">
            ...
            <div className="col-12 col-lg-7 mvp-planner-right-body-inner-sec1">
              <a href="/planner" className="btn mvp-btn-launch-task d-flex align-items-center gap-2 btn-svg-btn">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8 1H1V8H8V1Z" stroke="#4F4F4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M19 1H12V8H19V1Z" stroke="#4F4F4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M19 12H12V19H19V12Z" stroke="#4F4F4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M8 12H1V19H8V12Z" stroke="#4F4F4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>

                Explore by Category
              </a>
              <a href="/create-newtask-planner"  className="btn mvp-btn-launch-task d-flex align-items-center gap-2 btn-svg-btn">
                <FaPlus />
                Add Custom Task
              </a>
            </div>
          ...
          <div className=" right-body-inner">
            <div className="row ">
              <div className="col-12 col-lg-12">
                ...
                <div id="grids" >
                  <div id="grid-page1" class="grid-container" >
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/bathroom.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Bathroom</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/bedroom.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Bedroom</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item"><img
                      className="img-fluid"
                      src="/imgs/common-room.svg"
                      alt="alt"
                      width="78px"
                    />
                      <a className="mvp-no-text-deco" href="#"><span>Common Room</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        ...
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Pool</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/spa-and-sauna.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Spa & Sauna</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        ...
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Gym</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item"><img
                      className="img-fluid"
                      src="/imgs/coin-bbq.svg"
                      alt="alt"
                      width="78px"
                    />
                      <a className="mvp-no-text-deco" href="#"><span>Coin BBQ</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        ...
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Bureau</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/courtyard.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>courtyard</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        ...
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Salon</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        ...
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Garage</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/home-theater.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Home Theater</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/game-room.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Game Room</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/kitchen.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Kitchen</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/storage.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Storage</span></a>
                    </div>
                  </div>


                  <div id="grid-page2" class="grid-container page-hide" >
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/foundation.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Piles and
                        Foundations</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item"><img
                      className="img-fluid"
                      ...
                      width="78px"
                    />
                      <a className="mvp-no-text-deco" href="#"><span>Alarm Systems</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/excavation.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Excavation</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        ...
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Isolation</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        ...
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Siding</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        ...
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Law</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/plumbing.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Plumbing</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item"><img
                      className="img-fluid"
                      src="/imgs/electricity.svg"
                      alt="alt"
                      width="78px"
                    />
                      <a className="mvp-no-text-deco" href="#"><span>Electricity</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/heating.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Heating</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/refrigeration.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Refrigeration</span></a>
                    </div>
                    ...
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        ...
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Doors</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/windows.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Windows</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/ventilation.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Ventilation</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/masonry.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Masonry</span></a>
                    </div>
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/wood-frame.svg"
                        alt="alt"
                        width="78px"
                      />
                      <a className="mvp-no-text-deco" href="#"><span>Wood frames</span></a>
                    </div>
                  </div>


                  <div id="grid-page3" class="grid-container page-hide">
                    <div class="grid-item mvp-planner-grid-item">
                      <img
                        className="img-fluid"
                        src="/imgs/law.svg"
            ...
            <div class="pagination right-body-paginaton-sec-gen" id="pagination-controls">
              <div class="left-pagination-wrapper">
                <button disabled="">Back</button>
              </div><div class="pagination-button-wrapper">
